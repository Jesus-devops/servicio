...
<?php
 $query = "SELECT * FROM anexoe ae join alumno a on a.noControl=ae.noControl WHERE creditosAcumulados>180 and a.semestre='".$_SESSION['semestre']."' and a.grupo='".$_SESSION['grupo'].' '.$_SESSION['turno']."' ORDER By a.noControl";
$salida='';
